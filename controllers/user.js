...
const logout = (req,res)=>{
    res.status(200).clearCookie("token", null ).json({
        sucess:true,
...
const ForgotPassword = async (req,res,)=>{
    const user = await User.findOne({email:req.body.email})
        ...
        const resetPasswordURL = `${req.protocol}://${req.get("host")}/password/forgot/${resetToken}`
...
module.exports = {Register,login,logout,ForgotPassword ,updatePassword ,resetPassword,getUserDetails,
