...
const { getAllProducts ,createProduct,updateProduct,DeleteProduct,getProduct, Review, getAllReviews, DeleteReview, getAdminProducts} = require('../controllers/products');
...
router.route('/admin/products').get(isAuthenticated,admin("admin"),getAdminProducts)
